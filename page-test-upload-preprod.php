...
//Prendre order_id pas order_item_id pour prendre toute la commande
...
foreach ($commandes as $key => $value) {
  ...
  //Nom et distance de la course + nombre de participants
  ...
  while ($compteur < $nombre_participant) {
    ...
    foreach ($positions as $position) {
      ...
      //Mécanisme d'upload
      if (isset($_POST['upload_certificat_'.$btn_upload])) {
        ...
        echo "<pre>";
        var_dump($ancien_path_certificat);
        echo "</pre>";
    ...
    //Script rechargement page après upload du nouveau certificat
