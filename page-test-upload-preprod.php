...
?>
      ...
      <div class="container">
        ...
        ?>
          ...
          ?>
                <?php if ($ext == "pdf") {
                  echo "<strong>Certificat ou licence</strong><iframe src='$meta_value_path' frameborder='1' height='250px' width='250px'></iframe>"; //Affiche un iframe si l'extension du certificat actuel est un pdf
                } else {
                  echo "<strong>Certificat ou licence :</strong><a href='$meta_value' target='_blank'><img src='$meta_value_path' width='250px' height='250px'></a>"; //Affiche l'image si l'extension du certificat est un png, jpeg ou jpg
                } ?>
                    ...
                    echo "le fichier existe déja";
                      ...
                      if ($upload) {
                        ...
                        //Query qui modifie le statut modification certificat
                          ...
                          $request_verif = $wpdb->query($wpdb->prepare("UPDATE $tablename SET meta_value = '%s' WHERE order_item_id = '%d' AND meta_key = '$meta_key_verif'", array($new_meta_value_verif, $request_order_item_id)));                          echo "Changement status de modification changé";
